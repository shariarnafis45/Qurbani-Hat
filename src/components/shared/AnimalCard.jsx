...
const AnimalCard = ({ animal }) => {
  return (
    <div className="rounded-lg shadow-lg overflow-hidden p-2 flex flex-col ">
      ...
      <div className="p-5 mt-4 bg-white space-y-2 flex-grow">
        <h2
        ...
        {/* description */}
        <p className="font-medium text-[#2A3D2D] text-[0.9rem] mt-4">
          {animal.description}
        </p>
      </div>
      <div className="flex flex-col justify-center  gap-2 px-2 pb-4">
        <Link href={"/"} className="btn rounded-lg  transition bg-[#2A3D2D] text-white w-full">
          <button className="flex items-center gap-2 cursor-pointer font-medium">
            <RiShoppingCartFill />
            Book Now
          </button>
        </Link>
        <Link href={"/"} className="btn rounded-lg  transition text-[#2A3D2D] border border-[#2A3D2D] ">
          <button className="flex items-center gap-2 cursor-pointer font-medium">
            <FaEye />
